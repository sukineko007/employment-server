package com.manage.employ.aop;

import com.manage.employ.EmployApplication;
...
public class LogAspect {
    protected static final Logger logger = LoggerFactory.getLogger(EmployApplication.class);

    @Pointcut("execution(public * com.manage.employ.controller.*.*(..))")
    public void webLog() {
    }
